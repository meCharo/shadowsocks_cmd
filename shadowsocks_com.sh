...
pre_install(){
    ...
    read -p "(Default password: changhao):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="changhao"
    echo
    echo "---------------------------"
    ...
    read -p "(Default port: 25000):" shadowsocksport
    [ -z "$shadowsocksport" ] && shadowsocksport="25000"
